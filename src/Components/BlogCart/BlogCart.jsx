...
const BlogCart = ({blog}) => {
    ...
    return (
            ...
            <Link rel="noopener noreferrer" to={`/blog/${id}`} className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-50 transition border-2 hover:scale-105 border-primary hover:secondary border-opacity-30">
